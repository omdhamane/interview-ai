...
const { $schema: _interviewReportSchemaVersion, ...interviewReportJsonSchema } = z.toJSONSchema(interviewReportSchema)
...
async function generateResumePdf({ resume, selfDescription, jobDescription }) {
    ...
    const { $schema: _resumePdfSchemaVersion, ...resumePdfJsonSchema } = z.toJSONSchema(resumePdfSchema)
